...
class FormProvider with ChangeNotifier {
  ...
  void initData({
    ...
    for (final step in steps) {
      ...
      for (final FieldFormModel field in step.fields) {
        ...
        //TODO update FieldFormModel to add error_msg
  ...
  void updateData(String stepId, String fieldId, dynamic value, [int? index, String? stepTitle, String? defaultImageUrl, bool appearIfNull = false]) {
