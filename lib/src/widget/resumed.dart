...
class FormResumed extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final themeData = loadThemeData(theme, themeName ?? "form_resumed_kosmos", () => const ResumedThemeData())!;
          ...
          children: [
            Expanded(
              child: (title != null || data["title"] != null)
                  ? Text(
                      title ?? data["title"] ?? "",
                      style: titleStyle ?? themeData.titleStyle ?? TextStyle(color: const Color(0xFF02132B), fontSize: sp(20)),
                    )
                  : const SizedBox(),
            ),
            sw(20),
            if (showCreationDate && data["createdAt"] != null)
              Text(
                ...
                style: dateStyle ??
                    ...
                    TextStyle(color: const Color(0xFF02132B).withOpacity(.65), fontSize: sp(14), fontWeight: FontWeight.w500),
              ),
          ],
        ),
        ...
        ...((data["step"] as List<dynamic>?)?.map((e) {
              ...
              return Column(
                ...
                children: [
                  ...
                  if (e != (data["step"] as List<dynamic>).last) sh(themeData.verticalSectionSpacing ?? 6),
                ],
              );
            }).toList() ??
            []),
  ...
  static Widget buildSection(
    ...
    return Container(
      padding: padding ?? themeData.sectionPadding ?? EdgeInsets.symmetric(horizontal: formatWidth(19), vertical: formatHeight(11)),
      width: double.infinity,
      decoration: BoxDecoration(
        border: Border.all(
          color: borderColor ?? themeData.borderColor ?? const Color(0xFF02132B).withOpacity(.11),
          width: borderWidth ?? themeData.borderWidth ?? 1,
        ),
        color: backgroundColor ?? themeData.backgroundColor ?? Colors.transparent,
        borderRadius: borderRadius ?? themeData.borderRadius ?? BorderRadius.circular(9),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          if (sectionData["title"] != null || sectionData["can_modify"] != false) ...[
            Row(
              mainAxisSize: MainAxisSize.max,
              children: [
                Expanded(
                ...
                if (sectionData["can_modify"] != false && authorizeModify)
                  InkWell(
                    onTap: () {
                      printInDebug("modify ${sectionData["id"]} with index ${sectionData["step_index"]}");
                      if (onTapModify != null) onTapModify(formId, sectionData["step"] ?? 0);
                    },
                    child: Row(
                      children: [
                        SvgPicture.asset(
                          themeData.modifyIconPath ?? "assets/svg/ic_modify.svg",
                          package: (themeData.modifyIconPath != null) ? null : "form_kosmos",
                        ...
                        Text(
                          ...
                          style: modifyStyle ??
                              ...
                              TextStyle(
                                color: const Color(0xFF64C3BE).withOpacity(.65),
                                fontSize: sp(12),
          ...
          if (sectionData["fields"] != null) ...[
            ...(sectionData["fields"] as List<dynamic>).map((e) {
              printInDebug(e);
              if (e["data"] == null && e["appear_if_null"] == false) return Container();
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                  ...
                  if (e["data"] != null && e["data"] is Timestamp)
                    Text(
                      ...
                      style: e["data"] != null
                          ? fieldTitleStyle ??
                              themeData.fieldTitleStyle ??
                              TextStyle(
                                color: const Color(0xFF02132B).withOpacity(.6),
                                fontSize: sp(12),
                    ...
                    Container(
                      ...
                      child: CachedNetworkImage(imageUrl: e["defaultValueImage"] as String, fit: BoxFit.cover),
                    )
